...
MODEL = Literal["B0", "B1", "B2", "B3", "B4", "B5", "B6"]


@COMPONENTS.register(
    "HGNetV2",
    ctype=ComponentType.MODEL,
    supported_tasks=[Task.SEMANTIC_SEGMENTATION, Task.OBJECT_DETECTION],
    provider="PaddlePaddle",
    description="Full info https://github.com/PaddlePaddle/PaddleDetection"
    "/blob/develop/ppdet/modeling/backbones/hgnet_v2.py",
)
